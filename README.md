...
PClubTask4
    ...
    The slope m and intercept b of the bestfit line are calculated by minimizing the mean squared error which is given by: MSE = $1/N$ $(\sum_{k=1}^n \left(y<sub>i</sub> - \left(mx<sub>i</sub> +b\right)\right))$
